    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-16">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-text-muted)] mt-2 text-sm">Sign in to your ShopCart account</p>
        </div>
        ...
        >
          {/* Email */}
          <div>
            <label htmlFor="login-email" className="block text-sm font-medium text-[var(--color-text-muted)] mb-1.5">
              Email address
            </label>
            <input
              id="login-email"
          ...
          {/* Password */}
          <div>
            <label htmlFor="login-password" className="block text-sm font-medium text-[var(--color-text-muted)] mb-1.5">
              Password
            </label>
          ...
          {/* Demo hint */}
          <div className="rounded-lg bg-[var(--color-surface-2)] border border-[var(--color-border)] p-3 text-xs text-[var(--color-text-muted)]">
            <strong className="text-[var(--color-accent-light)]">Demo:</strong> test1@example.com / password123
          </div>
          ...
          <p className="text-center text-sm text-[var(--color-text-muted)]">
            ...
            <Link to="/register" id="login-register-link" className="text-[var(--color-accent-light)] hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </form>
