...
public class DataSeeder implements CommandLineRunner {
	...
	/**
	 * Default seed password sourced from environment / property so that no
	 * plain-text credential ever lives in source code (addresses java:S6437).
	 */
	@Value("${app.seed.password:#{null}}")
	...
	public void run(String... args) {
		...
		final String password = (seedPassword != null && !seedPassword.isBlank())
				? seedPassword
				: generateDefaultSeedPassword();
		...
		List<Product> products = productRepository.saveAll(List.of(
				product("Wireless Noise-Cancelling Headphones",
						"Premium over-ear headphones with 30-hour battery life and active noise cancellation.", 29999,
						45),
				product("Mechanical Keyboard",
						"Tenkeyless mechanical keyboard with Cherry MX Red switches and RGB backlight.", 8999, 120),
				product("4K USB-C Monitor", "27-inch 4K IPS display with USB-C power delivery and 99% sRGB coverage.",
						49999, 30),
				product("Ergonomic Office Chair", "Breathable mesh chair with lumbar support and adjustable armrests.",
						39999, 15),
				product("Laptop Stand (Aluminum)", "Foldable aluminum stand compatible with all 11-17 inch laptops.",
						3499, 200),
				product("Smart LED Desk Lamp",
						"Touch-controlled desk lamp with 5 color temperatures and USB-A charging port.", 2999, 88),
				product("Portable SSD 1TB", "USB 3.2 Gen 2 portable SSD with read speeds up to 1050 MB/s.", 11999, 60),
				product("Webcam 4K 60fps", "Ultra-HD webcam with autofocus, dual microphone, and low-light correction.",
						9499, 40),
				product("USB-C Hub 7-in-1",
						"Multi-port hub with HDMI, USB-A x3, SD card reader, and 100W PD pass-through.", 4299, 150),
				product("Mouse Pad XL", "Extended desk mat (90x40 cm) with non-slip rubber base and stitched edges.",
						1999, 300),
				product("Wireless Gaming Mouse",
						"High-precision 25K DPI sensor with 70-hour battery and customizable RGB.", 7499, 75),
				product("Smart Plug 4-Pack",
						"Wi-Fi smart plugs with energy monitoring, compatible with Alexa and Google Home.", 3999, 50),
				product("Portable Bluetooth Speaker",
						"Waterproof IPX7 speaker with 360-degree sound and 24-hour playback.", 6999, 65),
				product("Action Camera 4K",
						"Waterproof action camera with EIS stabilization and 170-degree wide angle.", 19999, 25),
				product("Noise-Cancelling Earbuds",
						"True wireless earbuds with ANC, transparency mode, and 28-hour total battery.", 14999, 55),
				product("Smart Watch Series 5", "Health & fitness smartwatch with GPS, ECG, SpO2, and 7-day battery.",
						24999, 35),
				product("E-reader 10-inch", "Glare-free e-ink display with adjustable warm light and 32 GB storage.",
						17999, 20),
				product("Robot Vacuum Cleaner", "LiDAR-mapped robot vacuum with mop function and 180-minute runtime.",
						34999, 12),
				product("Air Purifier HEPA H13", "360-degree air purifier covering up to 60 m² with PM2.5 display.",
						22999, 18),
				product("Standing Desk Converter",
						"Height-adjustable desk converter with dual-monitor shelf and keyboard tray.", 27999, 10)));
		...
		log.info("Database seeded. Users: test1@example.com / test2@example.com");
	}

	/**
	 * Generates a non-static default password for dev seeding when no
	 * {@code app.seed.password} property is provided. This avoids embedding
	 * a hard-coded credential in source (java:S6437).
	 */
	private String generateDefaultSeedPassword() {
		// Use a well-known dev-only value; must be overridden in any shared env.
		return "dev-" + Long.toHexString(System.currentTimeMillis());
	}
